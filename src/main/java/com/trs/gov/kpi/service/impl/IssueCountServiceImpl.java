    ...
    private DeptCountResponse getResponse(Integer[] siteIds, IssueIndicator type, IssueCountRequest request) throws RemoteException {
        ...
        for (Map<String, Object> map : mapList) {
            ...
            if (map.get(IssueTableField.DEPT_ID) == null || "".equals(map.get(IssueTableField.DEPT_ID))) {
                ...
                deptCount = new DeptCount(deptApiService.findDeptById("", (int) map.get(IssueTableField.DEPT_ID)).getGName() == null ? Constants.DEPT_NULL : deptApiService.findDeptById("", (int) map.get(IssueTableField.DEPT_ID)).getGName(), ((Long) map.get(COUNT)).intValue());
            }
    ...
    private List<DeptCount> getDepCountByType(Integer[] siteIds, IssueCountByTypeRequest request) throws RemoteException {
        ...
        for (Map<String, Object> countMap : depIssueCountList) {
            ...
            if (depId == null) {
                ...
                result.add(new DeptCount(deptApiService.findDeptById("", depId).getGName() == null ? Constants.DEPT_NULL : deptApiService.findDeptById("", depId).getGName(), count.intValue()));
            }
        }
        return result;
    }
