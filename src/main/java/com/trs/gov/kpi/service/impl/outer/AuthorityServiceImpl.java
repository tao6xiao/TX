...
public class AuthorityServiceImpl implements AuthorityService {
    ...
    public boolean hasRight(Integer siteId, Integer channelId, String oprkeys) throws RemoteException {
        ...
        try {
            ...
            Response response = client.newCall(buildRequest("hasRight", params, "gov_right", "kpitest")).execute();
    ...
    @Override
    public String getRoleByUser() throws RemoteException {
        Map<String, String> params = new HashMap<>();
        try {
            OkHttpClient client = new OkHttpClient();
            Response response = client.newCall(buildRequest("findUserById", params, "gov_user", "kpitest")).execute();
