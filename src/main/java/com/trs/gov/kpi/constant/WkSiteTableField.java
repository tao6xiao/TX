...
public interface WkSiteTableField {
    ...
    public static final String SITE_INDEX_URL = "siteIndexUrl";
    public static final String DEPT_ADDRESS = "deptAddress";
    public static final String DEPT_LATLNG = "deptLatLng";
    public static final String AUTO_CHECK_TYPE = "autoCheckType";
