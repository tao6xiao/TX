...
public class MonitorSiteController {
    ...
    public Object save(@ModelAttribute MonitorSiteDeal monitorSiteDeal) throws BizException, RemoteException {
        if (!authorityService.hasRight(monitorSiteDeal.getSiteId(), null, Authority.KPIWEB_MONITORSETUP_UPDATEADMIN) && !authorityService.hasRight(null, null, Authority
                .KPIWEB_MONITORSETUP_UPDATEADMIN)) {
            throw new BizException(Authority.NO_AUTHORITY);
        }
