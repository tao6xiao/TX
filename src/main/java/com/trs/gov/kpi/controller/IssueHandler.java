...
public class IssueHandler {
    ...
    public String handIssuesByIds(int siteId, List<Integer> ids) throws RemoteException, BizException {
    ...
    public String ignoreIssuesByIds(int siteId, List<Integer> ids) throws RemoteException, BizException {
    ...
    public String delIssueByIds(int siteId, List<Integer> ids) throws RemoteException, BizException {
    ...
    public String updateDeptByIds(int siteId, List<Integer> ids, int deptId) throws RemoteException, BizException {
