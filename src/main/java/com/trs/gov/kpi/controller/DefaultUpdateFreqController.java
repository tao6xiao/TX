...
public class DefaultUpdateFreqController {
    ...
    public Object save(@ModelAttribute DefaultUpdateFreq defaultUpdateFreq) throws BizException, ParseException, RemoteException {
        if (!authorityService.hasRight(defaultUpdateFreq.getSiteId(), null, Authority.KPIWEB_INDEXSETUP_UPDATEDEMANDFREQ) && !authorityService.hasRight(null, null, Authority
                .KPIWEB_INDEXSETUP_UPDATEDEMANDFREQ)) {
            throw new BizException(Authority.NO_AUTHORITY);
        }
